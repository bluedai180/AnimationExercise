...
/**
 * Created by huanggecheng on 2017/9/18.
 */

public class MateBall extends View implements View.OnClickListener{
    ...
    private Path mPath;
    public MateBall(Context context) {
        super(context);
    }

    public MateBall(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    ...
    public MateBall(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
